...
# * use something like that: bsub -q long -o lsf.log -M 256000 -n 48 -R'select[mem>256000, tmp>500G] rusage[mem=256000, tmp=600G]' gx_wrapper.bash -f /my/fasta.fa.gz -o /my/outdir/ -t 1234
